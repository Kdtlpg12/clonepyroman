...
async def alive(client: Client, message: Message):
    ...
    man = (
        f"**[Miku-Userbot](https://github.com/mrismanaziz/PyroMan-Userbot) is Up and Running.**\n\n"
        f"<b>{alive_text}</b>\n\n"
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/idoganzzbot)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/idoganz_store)** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={client.me.id})**"
    )
    try:
